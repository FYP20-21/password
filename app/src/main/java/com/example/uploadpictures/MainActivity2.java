        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (fileDoneList.size() > 3) {
                    Intent intent = new Intent(MainActivity2.this, UploadPasswords.class);
                    startActivity(intent);
                }else{
                    Toast.makeText(MainActivity2.this, "Please upload at least 4 photos.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
        ...
        if(requestCode == RESULT_LOAD_IMAGE && resultCode == RESULT_OK) {
            ...
            if(data.getClipData() != null){
                ...
                if (totalItemSelected > 3){
                    ...
                    Toast.makeText(MainActivity2.this, "Please select at least 4 photos", Toast.LENGTH_SHORT).show();
                }
            }else if (data.getData() != null){
                Toast.makeText(MainActivity2.this, "Selected Single Files", Toast.LENGTH_SHORT).show();
            }
        }
    }
